...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new SimpleBar(document.querySelector('.session-scroll'));
});
function floatchart() {
  // [ student-chart ] start
  (function () {
  ...
  (function () {
    ...
    var options_monthly_report = {
      ...
      colors: ['#4099ff', '#4099ff', '#4099ff', '#7C57C1'],
      fill: {
        opacity: [0.6, 1,  0.6, 1]
      },
      grid: {
    ...
    var options_overview_bar = {
      ...
      colors: ['#ff5370', '#4099ff', '#673ab7', '#2ed8b6', '#ffb64d', '#00bcd4'],
    ...
    var options_performance = {
      ...
      series: [27, 23, 20, 17],
      colors: ['#4099ff', '#ffb64d', '#2ed8b6', '#4099ff'],
