...
setTimeout(function () {
  (function () {
    ...
    var options_bar_chart_2 = {
      ...
      colors: ['#4099ff', '#2ed8b6', '#ffb64d', '#00bcd4'],
      responsive: [
        {
          breakpoint: 480,
          options: {
    ...
    var options_bar_chart_4 = {
      ...
      colors: ['#4099ff', '#00bcd4', '#2ed8b6', '#ffb64d', '#ff5370'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
    ...
    var options_bubble_chart_1 = {
      ...
      colors: ['#4099ff', '#2ed8b6', '#ffb64d', '#ff5370'],
            fill: {
                type: 'gradient',
                gradient: {
                    shade: 'light',
    ...
    var options_scatter_chart_1 = {
      ...
      colors: ['#4099ff', '#2ed8b6', '#ff5370', '#ffb64d', '#00bcd4'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
    ...
    var options_pie_chart_1 = {
      ...
      colors: ['#4099ff', '#2ed8b6', '#00bcd4', '#ffb64d', '#ff5370'],
      legend: {
        show: true,
        position: 'bottom'
      },
